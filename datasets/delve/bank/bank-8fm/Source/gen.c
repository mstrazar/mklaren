...
void setup(void)
{
  ...
  area[0].centre.x = erand48(rs2)-0.5;
  area[0].centre.y = erand48(rs2)-0.5;
  bank[1].loc.x = erand48(rs2)-0.5;
  bank[1].loc.y = erand48(rs2)-0.5;
  area[1].pop = 3.1*rand_exp(rs2);
  area[2].pop = 3.1*rand_exp(rs2);
...
double do_sim(void)
{
  ...
  area[1].pop = area[1].pop * (0.8 + 0.4*erand48(rs1));
  area[2].pop = area[2].pop * (0.8 + 0.4*erand48(rs1));
  return sim();
}
