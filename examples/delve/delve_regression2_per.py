...
gam_range = logspace(0, p_range[0], base=2)
            ...
            for lbd in lbd_range:
                try:
                    if mname == "Mklaren":
                        ...
                        print("\n Mklaren pivots:")
                        for pi in range(len(kernels)):
                            print(kernels[pi][0], len(model.data[pi]["act"]))
